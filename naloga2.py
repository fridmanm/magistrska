...
Cls_in_bin=8          #število l v enem binu
...
chiaxis=np.linspace(0,60,120)

plt.figure()
plt.hist(rand_stat, bins, log=False, label='Naključne mape')
plt.plot(chiaxis,17*35*st.chi2.pdf(chiaxis,3*Nside/Cls_in_bin),label='Porazdelitev $\chi^2$ za dof=%d' % int(3*Nside/Cls_in_bin))
